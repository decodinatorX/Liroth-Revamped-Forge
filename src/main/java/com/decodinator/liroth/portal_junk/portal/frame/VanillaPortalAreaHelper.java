...
public class VanillaPortalAreaHelper extends PortalFrameTester {
    ...
    public void lightPortal(Block frameBlock) {
        ...
        BlockState blockState = CustomPortalHelper.blockWithAxis(link != null ? link.getPortalBlock().defaultBlockState() : Liroth.getDefaultPortalBlock().defaultBlockState(), axis);
