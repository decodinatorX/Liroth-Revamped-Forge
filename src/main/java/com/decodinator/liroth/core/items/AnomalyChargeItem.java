...
public class AnomalyChargeItem extends Item {
    public AnomalyChargeItem() {
...
/*        if(context.getPlayer() != null) {
            if(context.getPlayer().level.dimension() == LirothDimensions.JANTIROS_ESCAPE
                ...
                for(Direction direction : Direction.Plane.VERTICAL) {
                    ...
                    if(((DevastatedPortalBlock) LirothBlocks.DEVASTATED_DIMENSION_PORTAL.get()).trySpawnPortal(context.getLevel(), framePos)) {
