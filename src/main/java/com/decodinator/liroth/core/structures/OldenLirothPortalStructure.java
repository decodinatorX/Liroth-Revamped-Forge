package com.decodinator.liroth.core.structures;
...
public class OldenLirothPortalStructure extends Structure {
    ...
    public StructureType<?> type() {
        return LirothStructures.OLDEN_LIROTH_PORTAL.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}