...
public class LirothPortalBuilders {
	...
	public static void init() {
        ...
        .customPortalBlock(LirothBlocks.DAMNATION_DIMENSION_PORTAL.get())
        ...
        .customPortalBlock(LirothBlocks.JANTIRO_DIMENSION_PORTAL.get())
        ...
        .customPortalBlock(LirothBlocks.JALSPHIRE_DIMENSION_PORTAL.get())
        ...
        .customPortalBlock(LirothBlocks.DEVASTATED_DIMENSION_PORTAL.get())
