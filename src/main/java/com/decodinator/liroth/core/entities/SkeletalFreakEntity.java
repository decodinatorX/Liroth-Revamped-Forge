...
public class SkeletalFreakEntity extends Skeleton {
    ...
    public void performRangedAttack(LivingEntity target, float pullProgress) {
        ...
        persistentProjectileEntity.shoot(d, e + g * (double)0.2f, f, 1.6f, 14 - this.getLevel().getDifficulty().getId() * 4);
        this.playSound(SoundEvents.SKELETON_SHOOT, 1.0f, 1.0f / (this.getRandom().nextFloat() * 0.4f + 0.8f));
        this.getLevel().addFreshEntity(persistentProjectileEntity);
    }
