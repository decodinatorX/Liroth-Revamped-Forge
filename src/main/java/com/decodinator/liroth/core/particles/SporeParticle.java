...
public class SporeParticle extends TextureSheetParticle {
	   protected SporeParticle(ClientLevel p_107631_, double p_107632_, double p_107633_, double p_107634_, double p_107635_, double p_107636_, double p_107637_) {
	...
	@Override
	   ...
	   public static class Provider implements ParticleProvider<SimpleParticleType> {
	      ...
	      public Particle createParticle(SimpleParticleType p_106838_, ClientLevel p_106839_, double p_106840_, double p_106841_, double p_106842_, double p_106843_, double p_106844_, double p_106845_) {
	    	  SporeParticle flameparticle = new SporeParticle(p_106839_, p_106840_, p_106841_, p_106842_, p_106843_, p_106844_, p_106845_);
