...
public class VileTentacleTipBlock  extends GrowingPlantHeadBlock implements LiquidBlockContainer {
	   protected static final VoxelShape SHAPE = Block.box(0.0D, 0.0D, 0.0D, 16.0D, 9.0D, 16.0D);
	   private static final double GROW_PER_TICK_PROBABILITY = 0.14D;

	   public VileTentacleTipBlock(BlockBehaviour.Properties p_54300_) {
	      super(p_54300_, Direction.UP, SHAPE, true, 0.14D);
	   }

	   protected boolean canGrowInto(BlockState p_54321_) {
	      return p_54321_.is(LirothBlocks.LIROTH_FLUID_BLOCK.get());
	   }

	   protected Block getBodyBlock() {
	      return LirothBlocks.VILE_TENTACLE.get();
	   }
