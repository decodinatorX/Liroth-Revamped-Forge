...
public class PetrifiedDamnationCraftingMenu extends CraftingMenu {

    private final ContainerLevelAccess access;

    public PetrifiedDamnationCraftingMenu(int p_39356_, Inventory p_39357_, ContainerLevelAccess p_39358_) {
        super(p_39356_, p_39357_, p_39358_);
        this.access = p_39358_;
    }

    public PetrifiedDamnationCraftingMenu(int p_39353_, Inventory p_39354_) {
    ...
    public boolean stillValid(Player p_39368_) {
        return stillValid(this.access, p_39368_, LirothBlocks.PETRIFIED_DAMNATION_CRAFTING_TABLE.get());
    }
}