...
public class SimpleQuantumSerializer<T extends AbstractQuantumRecipe>implements RecipeSerializer<T> {
	   private final int defaultCookingTime;
	   private final SimpleQuantumSerializer.CookieBaker<T> factory;

	   public SimpleQuantumSerializer(SimpleQuantumSerializer.CookieBaker<T> p_44330_, int p_44331_) {
	...
	@Override
	   public T fromJson(ResourceLocation p_44347_, JsonObject p_44348_) {
	      ...
	      return this.factory.create(p_44347_, s, ingredient, itemstack, bonus, f, i);
	   }
	   ...
	   public T fromNetwork(ResourceLocation p_44350_, FriendlyByteBuf p_44351_) {
	      ...
	      return this.factory.create(p_44350_, s, ingredient, itemstack, bonus, f, i);
	   }
	   ...
	   public interface CookieBaker<T extends AbstractQuantumRecipe> {
	      T create(ResourceLocation p_44353_, String p_44354_, Ingredient p_44355_, ItemStack p_44356_, RandomizedOutputIngredient fuckYou, float p_44357_, int p_44358_);
	   }
  }